...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.projects.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="developers">{{ trans('cruds.project.fields.developers') }}</label>
                <div style="padding-bottom: 4px">
                    <span class="btn btn-info btn-xs select-all" style="border-radius: 0">{{ trans('global.select_all') }}</span>
                    <span class="btn btn-info btn-xs deselect-all" style="border-radius: 0">{{ trans('global.deselect_all') }}</span>
                </div>
                <select class="form-control select2 {{ $errors->has('developers') ? 'is-invalid' : '' }}" name="developers[]" id="developers" multiple required>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.project.fields.developers_helper') }}</span>
            </div>
            <div class="form-group">
