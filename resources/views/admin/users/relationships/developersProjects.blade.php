...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-developersProjects">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($projects as $key => $project)
                        <tr data-entry-id="{{ $project->id }}">
                            ...
                            <td>
                                @foreach($project->developers as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-developersProjects:not(.ajaxTable)').DataTable({ buttons: dtButtons })
